 ...
 * 基础样式
 */
.codeplayground-right-menu-list {
  width: auto;
  z-index: 9999;
  position: fixed;
  display: block;
 ...
 * mac主题色
 */
.codeplayground-theme-mac {
  color: var(--codeplayground-menu-color);
  font-size: 13px;
  margin: 0;
  padding: 5px 4px;
  border-radius: 5px;
  background-color: var(--codeplayground-float-bgc);
  box-shadow: var(--codeplayground-menu-shadow);
  li {
  ...
  .codeplayground-active-menu-item {
    color: @brand;
    &:active {
      background-color: @brand-active;
    }
  }
  .codeplayground-not-active-menu-item {
    color: var(--codeplayground-menu-color);
  }
}
</style>
