<template>
  <div class="codeplayground-monaco-edito-outer">
    <div class="codeplayground-monaco-editor" ref="containerRef"></div>
...
.codeplayground-monaco-edito-outer {
  position: relative;
  height: 100%;
  .codeplayground-monaco-editor {
    position: relative;
    height: 100%;
    overflow: hidden;
  }
  ...
  &:hover {
    .code-copy-icon {
      ...
      background-color: var(--codeplayground-copy-icon-color);
      box-shadow: var(--codeplayground-copy-shadow);
      border-radius: 0;
      border-bottom-left-radius: 2px;
      &:hover {
        color: var(--codeplayground-brand-active);
      }
    }
  }
}
